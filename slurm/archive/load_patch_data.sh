...
#SBATCH --output=slurm/log/load_data/patch_%j.out
#SBATCH --error=slurm/log/load_data/patch_%j.err
...
export SLURM_STDOUT_PATH="$SLURM_SUBMIT_DIR/slurm/log/load_data/patch_${SLURM_JOB_ID}.out"
export SLURM_STDERR_PATH="$SLURM_SUBMIT_DIR/slurm/log/load_data/patch_${SLURM_JOB_ID}.err"
...
python -u imagenet_data_patched.py