#!/bin/bash
#SBATCH --job-name=dummy_vig
#SBATCH --output=slurm/log/train/dummy%j.out
#SBATCH --error=slurm/log/train/dummy%j.err
...
export SLURM_STDOUT_PATH="$SLURM_SUBMIT_DIR/slurm/log/train/dummy_${SLURM_JOB_ID}.out"
export SLURM_STDERR_PATH="$SLURM_SUBMIT_DIR/slurm/log/train/dummy_${SLURM_JOB_ID}.err"
