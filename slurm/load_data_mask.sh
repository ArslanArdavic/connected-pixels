...
#SBATCH --output=slurm/log/data/mask_%j.out
#SBATCH --error=slurm/log/data/mask_%j.err
...
export SLURM_STDOUT_PATH="$SLURM_SUBMIT_DIR/slurm/log/data/mask_${SLURM_JOB_ID}.out"
export SLURM_STDERR_PATH="$SLURM_SUBMIT_DIR/slurm/log/data/mask_${SLURM_JOB_ID}.err"
